...
<?php $__env->startSection('content'); ?>
    <div class="wrapper wrapper-register">
        <div class="form-box form-box-inputdialog">
            ...
            <br>
            <?php echo csrf_field(); ?>
            <?php echo e(Form::open(array('url' => '/modificaDatiL1', 'enctype' => 'multipart/form-data', 'method' => 'PUT'))); ?>
...
<?php echo $__env->make('layouts.skel', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Applicazioni\XAmpp\download\htdocs\ProgettoTecnologieWeb\resources\views/customer/modificaDatiL1.blade.php ENDPATH**/ ?>