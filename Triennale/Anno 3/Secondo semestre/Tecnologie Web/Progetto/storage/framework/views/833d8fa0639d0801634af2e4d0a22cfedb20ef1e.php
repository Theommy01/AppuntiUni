    ...
    <div class="container">
        <div class="panel">
            ...
            <div class="panel-buttons">
                <a class="btn btn-back" href="<?php echo e(route('hubStaff')); ?>">Torna indietro</a>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.skel', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Applicazioni\XAmpp\download\htdocs\ProgettoTecnologieWeb\resources\views/gestioneOfferte.blade.php ENDPATH**/ ?>