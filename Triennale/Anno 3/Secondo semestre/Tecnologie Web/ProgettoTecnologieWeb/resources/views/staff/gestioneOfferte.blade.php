...
@section('title', 'Gestione delle offerte')
            ...
            <table class="tabella">
                ...
                @foreach($List as $list)
                    <tr>
                        <td>{{$list['id']}}</td>
                        <td>{{$list['nome']}}</td>
                        <td title="Clicca qui per AGGIORNARE la seguente offerta"><a class="btn-table-update" href="{{ route('aggiornaOfferte', $list['id']) }}">Modifica</a></td>
